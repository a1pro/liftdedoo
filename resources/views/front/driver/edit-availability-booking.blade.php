            ...
            <div class="col-right">
                ...
                <div class="box">
                        ...
                        <div class="box-content">
                            <form id="booking" method="POST" action="{{ url('update-booking') }}">
                                @csrf
                                ...
                                <div class="field required ui-widget">
                                    ...
                                    <input type="text" id="start_location" class="typeahead input-text"
                                        name="start_location" placeholder=""  onChange="checkLocation(this.value)" value="{{$booking->startLocation}}" >
                                ...
                                <div class="field required">
                                    <label class="label"><span>Destination</span><span
                                            class="requard">*</span></label>
                                ...
                                <div class="field required w-100">
                                    <label class="label mb-0" class="booking_dates" id="availabe-text"
                                        style="width: 100%"><span>Available
                                            Time</span><span class="requard">*</span></label>
                                    <div class="w-100">
                                        <input type="text" data-format="yyyy-MM-dd" readonly class="booking_dates"
                                            id="start_time" name="start_time" value="{{date('d-m-Y H:i',strtotime($booking->start_time))}}" class="mt-2"  autocomplete="off">
                                        <span class="to" style="margin:0px 45px;">to</span>
                                        <input type="text" readonly class="booking_dates" id="end_time" name="end_time" value="{{date('d-m-Y H:i',strtotime($booking->end_time))}}"
                                            class="mt-2"  autocomplete="off">
                                    </div>
                                </div>
                                {{-- calander --}}
                                <input type="hidden" name="strtLocId" id="strtLocId" value="{{$booking->start_location_id}}">
