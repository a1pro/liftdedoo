        ...
        <div class="page-title-box">
            <div class="container-fluid">
                <div class="page-title dflex-between-center">
                    <h3 class="mb-1 font-weight-bold">Driver Booking Form</h3>
                    <ol class="breadcrumb mb-0 mt-1">
                        ...
                        <li class="breadcrumb-item active">Driver Booking Form</li>
                    </ol>
                </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form id="vehicle" class="needs-validation" method="POST"
                                    action="{{ url('add-admin-driver-booking') }}" novalidate>
                                    @csrf
                                    ...
                                    <div class="form-group">
                                        <label for="example-select">Vehicle Select</label>
                                    ...
                                    <button class="btn btn-primary" type="submit" id="bookingBtn">Submit</button>
                                </form>
                            </div> <!-- end card-body-->
                        </div> <!-- end card-->
                    </div> <!-- end col-->
