        ...
        <div class="page-title-box">
            <div class="container-fluid">
                <div class="page-title dflex-between-center">
                    <h3 class="mb-1 font-weight-bold">LocationTable</h3>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h5 class="card-title" style="float: right;"><a href="{{ url('location-form') }}"
                                        class="btn btn-primary waves-effect waves-light" data-effect="wave"><i
                                            class="bx bx-plus bx-flashing"></i> Add Location</a></h5>
                            </div>
                            <div class="card-body">
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($locations as $list)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ url('location-form') }}/{{ $list->id }}"><button
                                                            type="button" class="btn btn-info waves-effect waves-light"
                                                            data-effect="wave"><i
                                                                class="fe-edit"></i></button></a>
                                                    <button type="button"
                                                        class="btn btn-danger waves-effect waves-light"
                                                        data-effect="wave" onclick="deletedata(<?php echo $list->id; ?>)"> <i
